            ...
            try
            {
                ...
                return new OwnerDashboardDTO
                {
                    ...
                    ActiveContracts_Details = activeContracts.Select(c => new ContractSummaryDTO
                    {
                        ...
                        TenantName = tenants.FirstOrDefault(t => t.Id == c.TenantId)?.Name ?? "N/A",
                    ...
                    PendingPayments_Details = pendingBillings.Select(p => new PaymentPendingDTO
                    {
                        ...
                        TenantName = tenants.FirstOrDefault(t => t.Id == (contracts.FirstOrDefault(c => c.Id == p.ContractId)?.TenantId ?? 0))?.Name ?? "N/A",
                        Amount = p.Amount,
                        DueDate = p.DueDate,
